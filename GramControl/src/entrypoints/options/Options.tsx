                  ...
                  <div className="flex justify-between items-center space-x-3">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-yellow-700 mb-3">
                        To use Plus features like account management and
                        cross-device sync, we need permission to connect to our
                        backend server (https://api.groundedmomentum.com/).
                      </p>
                    </div>
                    <Button
                  ...
                  <div className="space-y-6 p-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center space-x-4 mb-4">
                        <Button
                          variant={
                            billingPeriod === "monthly" ? "default" : "outline"
                          }
                        ...
                        <Button
                          variant={
                            billingPeriod === "yearly" ? "default" : "outline"
                          }
                            ...
                            <>
                              ...
                              >
                                ...
                                >
                                  {/* {user.email} */}
                                  {user.isPro && (
                                    <span className="mt-2 ml-2 px-1 w-16 text-center py-1 flex items-center justify-center text-xs bg-gradient-to-r from-[#e496be] to-[#E6067A] text-white rounded-full font-semibold">
                              ...
                              <div className="space-y-4">
                                <div className="space-y-2">
                                  ...
                                  <Input
                                    ...
                                    disabled={
                                      isLoading || !hasBackendPermission
                                    }
                                  />
                                </div>
