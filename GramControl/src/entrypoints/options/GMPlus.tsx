...
import { paymentPageRedirect } from "../../lib/payments";
...
const STORE_URLS = {
  timeSnatch: {
    chrome:
      "https://chromewebstore.google.com/detail/time-snatch-block-website/epamlgdeklcjkldoaclgjdmjnchdgbho?hl=en",
    firefox:
      "https://addons.mozilla.org/en-US/firefox/addon/time-snatch-block-websites/",
    edge: "https://microsoftedge.microsoft.com/addons/detail/time-snatch-block-websi/lpaajokgonohalagaibbjbnnelcdfckg",
  },
  cadence: {
    chrome:
      "https://chromewebstore.google.com/detail/cadence-pomodoro-focus-ti/mjpanfloecbdhkpilhgkglonabikjadf?hl=en",
    firefox: "https://addons.mozilla.org/en-US/firefox/addon/cadence-pomodoro-focus-timers/",
...
export function GMPlus() {
  ...
  const tsUrl = STORE_URLS.timeSnatch[browser];
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between p-3 rounded-lg border border-primary/30 bg-primary/5">
                      <div className="flex items-center space-x-3">
                        <img src="/images/logo-256.png" className="w-8 h-8 rounded-md" />
                        <div>
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <img src="/icon/ts-128.png" className="w-8 h-8 rounded-md" />
                        <div>
              ...
              <>
                ...
                <div className="space-y-3">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between p-3 rounded-lg border border-primary/30 bg-primary/5">
                      <div className="flex items-center space-x-3">
                        <img src="/images/logo-256.png" className="w-8 h-8 rounded" />
                        <div>
                          <p className="text-sm font-medium">GramControl</p>
                          <p className="text-xs text-muted-foreground">
                            Block Instagram distractions
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <img src="/icon/ts-128.png" className="w-8 h-8 rounded" />
                        <div>
                          <p className="text-sm font-medium">Time Snatch</p>
                          <p className="text-xs text-muted-foreground">
                            Block distracting websites
